# CateringOS - Cursor Entry Point

Source of truth lives in `docs/_canon/`.

## Canon
- Runtime Targets (v1): `docs/_canon/runtime_targets_v1.md`
...
## Working Rules (Short)
- UI is Hebrew RTL. Code is English.
- Zero Guessing: never infer missing data. Ask or keep separate.
